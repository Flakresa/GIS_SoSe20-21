...
treeTop.style.backgroundColor = "pink";
treeTop.style.width = "400px";
treeTop.style.height = "400px";
...
let resetBtn: HTMLButtonElement = <HTMLButtonElement>document.getElementById("Neustart");
